...
//------------------ 样式定义 ---------------------------// 
//功能按钮同样样式 
var s_tiannet_turn_base = "height:16px;font-size:9pt;color:white;border:0 solid #CCCCCC;cursor:hand;background-color:#6B8E23;"; 
//翻年、月等的按钮 
...
//日期选择控件体的样式 
var s_tiannet_body = "width:150;background-color:#6B8E23;display:none;z-index:9998;position:absolute;" + 
