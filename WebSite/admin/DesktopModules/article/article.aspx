<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article.aspx.cs" Inherits="WebSite.admin.DesktopModules.article.article" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td align="right">搜索：<asp:DropDownList ID="ddlfield" runat="server" CssClass="select">
                        <asp:ListItem Value="O.[title]">名称</asp:ListItem>
                    </asp:DropDownList>
                ...
                <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                    <ItemTemplate>
                        <tr onmouseover="this.className='DataGrid_SelectedItem'" onmouseout="this.className='DataGrid_Item'"
                            ...
                            <td align="center">
                                <div style="float: left; width: 50px; height: 50px; overflow: hidden; border: 1px solid #eeeeee;"><%#showimg(Eval("img_url"))%></div>
                                <div style="float: left; height: 42px; padding: 4px;"><%#Eval("title")%></div>
                            ...
                            <td align="center">
                                <a href="editarticle.aspx?id=<%#Eval("id")%>">修改</a> | 
                            <asp:LinkButton ID="lbtnexec" runat="server" CommandArgument='<%#Eval("id")%>' CommandName="del" OnClientClick="return confirm('确定删除吗？');">删除</asp:LinkButton>
                            </td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
