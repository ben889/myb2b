<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ad_call_index.aspx.cs" Inherits="WebSite.admin.DesktopModules.Ad.ad_call_index" %>
            ...
            <table border="0" cellpadding="2" cellspacing="0" width="100%">
                <tr>
                    ...
                    搜索：<asp:DropDownList ID="ddlfield" runat="server">
                        ...
                        &nbsp;
                        <asp:Button ID="btn_Release" runat="server" Text="发布XML" CssClass="button save" 
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                ...
                <ItemTemplate>
                    <tr onmouseover="this.className='DataGrid_SelectedItem'" onmouseout="this.className='DataGrid_Item'"
                        ...
                        <td align="center">
                            <a href="editAd.aspx?adid=<%#Eval("adid")%>&call_index=<%=call_index %>">修改</a> | 
