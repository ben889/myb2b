...
namespace Common
{
    ...
    {
        #region   拼音码数组初始化
        public static int[] pyvalue = new int[]{-20319,-20317,-20304,-20295,-20292,-20283,-20265,-20257,-20242,-20230,-20051,-20036,-20032,-20026,  
                ...
                for (int i = 0; i < chrStr.Length; i++)
                {
                    try
                    {
                        ...
                        if (IsChineseCharacters(characters) && GetFirstFlag)
                            outStr += HzConverToPy(characters).Substring(0, 1);
                        else if (IsChineseCharacters(characters) && !GetFirstFlag)
                            outStr += HzConverToPy(characters);
                        else
                            outStr += characters;
                    }
                    catch { }
